    ...
    <Layout>
          ...
          <div className="row justify-content-center">
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="contact-info-box wow fadeInUp delay-0-2s">
                ...
                <h4>Locations</h4>
                <span>Al ttay street - Al Khawaneej - Dubai</span>
              </div>
            </div>
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="contact-info-box wow fadeInUp delay-0-3s">
                ...
                <h4>Email Us</h4>
                <a href="mailto:sales@alt-technologies.ae">
                sales@alt-technologies.ae
                </a>
                <br />
                <a href="http://www.alt-technologies.ae">www.alt-technologies.ae</a>
              </div>
            </div>
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="contact-info-box wow fadeInUp delay-0-4s">
                ...
                <span>
                Telephone : <a href="callto:043150333">043150333</a>
                </span>
                <span>
                  Mobile : <a href="callto:+971564833933">+971564833933</a>
                </span>
              </div>
            </div>
            <div className="col-xl-3 col-lg-4 col-md-6">
      ...
      <div className="contact-page-map wow fadeInUp delay-0-2s">
        <div className="our-location">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3609.129651277329!2d55.55329231124373!3d25.23255777759513!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef58b654f20222d%3A0x99bc6b503c833237!2sALT%20TECHNOLOGIES!5e0!3m2!1sen!2sae!4v1681725375558!5m2!1sen!2sae"

                ...
                <div className="about-btns">
                  ...
                  <div className="hotline mt-15">
                    ...
                    <div className="content">
                      <span>Hotline</span>
                      <br />
                      <a href="callto:043150333">043150333</a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="row align-items-center justify-content-between">
            <div className="col-xl-5 col-lg-6">
              <div className="cs-content-part rmb-35 wow fadeInLeft delay-0-2s">
                ...
                <p>
                  With over 10+ years of experience and 850+ employees board,
          ...
          <div className="row justify-content-center">
            <div className="col-xl-6 col-lg-8">
              <div className="section-title text-center mb-50 wow fadeInUp delay-0-2s">
                ...
                <h2>50+ Completed Projects in 4+ Countries</h2>
              </div>
            </div>
          </div>
            ...
            <div className="col-xl-4 col-md-6">
              <div className="counter-item-two counter-text-wrap wow fadeInUp delay-0-3s">
                ...
                <div className="content">
                  ...
                  <p>Over 10 years of experience and 850+ employees</p>
                </div>
              </div>
            </div>
            <div className="col-xl-4 col-md-6">
